...
class MarketReport extends Resource {
	
	public function MarketReport(Authentication $auth) {
	...
	public function getMarketReportSubscriptions(): MarketReportSubscriptions {
